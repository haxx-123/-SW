  ...
  if (!isOpen) {
    return (
      <button 
        ...
        className="mb-6 flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 text-slate-600 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors shadow-sm"
      >
        <Settings size={16} />
        调整对账参数 (Settings)
      </button>
